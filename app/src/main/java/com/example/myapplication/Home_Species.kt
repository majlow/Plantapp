...
class Home_Species : AppCompatActivity() {
        ...
        dbref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    userRecyclerview.adapter = speciesAdapter(this@Home_Species, userArrayList)
    ...
    private fun searchList(text: String) {
        ...
        userRecyclerview.adapter = speciesAdapter(this@Home_Species, searchList)
